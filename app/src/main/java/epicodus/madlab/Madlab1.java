...
public class Madlab1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_madlab1);
        ...
        mMadlibButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(output.equals("")) {
                    ...
                    Intent intent = new Intent(Madlab1.this, Output.class);
                    intent.putExtra("madLab", madLab);
                    startActivity(intent);
                } else {
                    Toast.makeText(Madlab1.this, output, Toast.LENGTH_SHORT).show();
                }
            }
        });
